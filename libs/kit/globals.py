...
PROJECT_ENV = None # project environment variables, in particular paths to DHPARAMS, etc.
TASK = None  # task definition
JOB = None  # job values like job id
MHPARAMS = None  # hyperparameters for the model
MHPARAMS_standard = None  # standard hyperparameters for the model that can be overwritten by yaml file
